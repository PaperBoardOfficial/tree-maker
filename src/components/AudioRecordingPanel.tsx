    ...
    <div className="w-96 h-full bg-gray-800 border-r border-gray-600 p-4 flex flex-col">
      ...
      <div className="mb-4 flex-1 flex flex-col">
        <textarea
          ...
          className="w-full h-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-100 placeholder-gray-400"
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={
            !textInput.trim() || isProcessing || isTranscribing || isValidating
          }
          className={`flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 ${
            textInput.trim() &&
            !isProcessing &&
